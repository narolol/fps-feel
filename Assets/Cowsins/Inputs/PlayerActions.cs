// GENERATED AUTOMATICALLY FROM 'Assets/Cowsins/Inputs/PlayerActions.inputactions'
    ...
    public struct GameControlsActions
    {
        ...
        public void SetCallbacks(IGameControlsActions instance)
        {
            if (m_Wrapper.m_GameControlsActionsCallbackInterface != null)
            {
                ...
                @Dashing.started -= m_Wrapper.m_GameControlsActionsCallbackInterface.OnDashing;
                @Dashing.performed -= m_Wrapper.m_GameControlsActionsCallbackInterface.OnDashing;
                @Dashing.canceled -= m_Wrapper.m_GameControlsActionsCallbackInterface.OnDashing;
